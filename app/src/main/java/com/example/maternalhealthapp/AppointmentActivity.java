...
public class AppointmentActivity extends AppCompatActivity {
    ...
    private AppointsAdapter appointsAdapter;
    ...
    public void getAppointments() {
        ...
        RecyclerView appointmentRecycler = (RecyclerView) findViewById(R.id.appointments_recycler_view);
        appointsAdapter = new AppointsAdapter(this, appointments);
        appointmentRecycler.setAdapter(appointsAdapter);
        appointmentRecycler.setLayoutManager(new GridLayoutManager(AppointmentActivity.this, 1));
        Query myDoctorsQuery = myRef.orderByChild("doctor_id").equalTo(userId);
