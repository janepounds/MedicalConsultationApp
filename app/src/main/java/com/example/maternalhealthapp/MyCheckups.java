...
//        setSupportActionBar(toolbar);
        treatments_recyclerview = (RecyclerView) findViewById(R.id.my_treatments_recycler_view);
        progressDialog = new ProgressDialog(MyCheckups.this);
    ...
    public void getTreatments() {
        ...
        treatments_recyclerview.setLayoutManager(new GridLayoutManager(MyCheckups.this, 1));
        Query myDoctorsQuery = myRef.orderByChild("patientId").equalTo(userId);
